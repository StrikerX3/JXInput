...
#include "com_github_strikerx3_jxinput_natives_XInputNatives14.h"
...
#pragma warning(disable : 4995) // XInputEnable was marked as #pragma deprecated
JNIEXPORT void JNICALL Java_com_github_strikerx3_jxinput_natives_XInputNatives14_setEnabled
  (JNIEnv *env, jclass cls, jboolean enabled)
{
	XInputEnable(enabled ? TRUE : FALSE);
}

JNIEXPORT jint JNICALL Java_com_github_strikerx3_jxinput_natives_XInputNatives14_getCapabilities
...
JNIEXPORT jint JNICALL Java_com_github_strikerx3_jxinput_natives_XInputNatives14_getBatteryInformation
...
JNIEXPORT jint JNICALL Java_com_github_strikerx3_jxinput_natives_XInputNatives14_getKeystroke
