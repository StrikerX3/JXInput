...
#include "com_github_strikerx3_jxinput_natives_XInputNatives.h"
	...
	public:
		...
		void ensureLoaded()
		{
			if (!mLoaded)
			{
				...
				mHandle = LoadLibraryA("xinput1_4.dll");
				...
				if (mHandle == NULL)
				{
					mHandle = LoadLibraryA("xinput1_3.dll");
				...
				if (mHandle == NULL)
				{
					mHandle = LoadLibraryA("xinput9_1_0.dll");
